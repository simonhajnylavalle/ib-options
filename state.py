...
def _to_dict(play: Play) -> dict:
    ...
    return {
        ...
        "exit_profile": {
            ...
            "trail_activate_pct": ep.trail_activate_pct,
            "trail_drawdown_pct": ep.trail_drawdown_pct,
...
def _from_dict(d: dict) -> Play:
    ...
    exit_profile = ExitProfile(
        ...
        trail_activate_pct=ep_d.get("trail_activate_pct"),
        trail_drawdown_pct=ep_d.get("trail_drawdown_pct"),
